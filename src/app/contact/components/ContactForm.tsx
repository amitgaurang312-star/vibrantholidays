      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className={`text-center mb-10 reveal-up ${visible ? 'active' : ''}`}>
          ...
          <p className="text-muted-foreground text-sm max-w-md mx-auto">
            Call us or fill in the enquiry form — we respond within 2 hours.
          </p>
        </div>
        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-12 reveal-up ${visible ? 'active' : ''}`} style={{ transitionDelay: '100ms' }}>
          {/* Option 1 — Call Us */}
          <div className="flex flex-col items-center text-center bg-white rounded-2xl border-2 border-primary/20 p-6" style={{ boxShadow: '0 4px 20px rgba(11,138,143,0.12)' }}>
            <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-3" style={{ background: 'rgba(11,138,143,0.10)' }}>
              <svg className="w-6 h-6" fill="none" stroke="#0B8A8F" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 8V5z" />
              </svg>
            </div>
            <span className="text-xs font-bold uppercase tracking-widest text-primary mb-1">Option 1</span>
            <h3 className="font-display font-semibold text-foreground text-base mb-1">Call Us</h3>
            <p className="text-muted-foreground text-xs mb-4 leading-relaxed">Speak directly with our travel expert right now.</p>
            <a
              ...
              style={{ background: 'linear-gradient(135deg, #0B8A8F, #067A7F)', boxShadow: '0 4px 16px rgba(11,138,143,0.35)' }}
            >
