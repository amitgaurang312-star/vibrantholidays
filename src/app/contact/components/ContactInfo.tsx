        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-sm">
              Call us now or drop a WhatsApp message — we respond within minutes.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0 relative z-10">
            ...
            <a
              href="https://wa.me/918668355974?text=Hi%20Vibrant%20Holidays!%20I%20want%20to%20plan%20a%20trip."
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 border-2 border-white text-white px-6 py-3 rounded-full font-semibold text-sm transition-all duration-300 hover:bg-white hover:text-primary"
            >
