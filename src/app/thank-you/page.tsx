...
export default function ThankYouPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-12 sm:py-16 relative overflow-hidden"
    ...
    >
      ...
      <div className={`relative z-10 w-full max-w-lg text-center ${mounted ? '' : 'opacity-0'}`}>
        ...
        <div className="plane-float mb-5 sm:mb-6 inline-block">
          <div
            className="w-14 sm:w-16 h-14 sm:h-16 rounded-2xl flex items-center justify-center mx-auto"
            style={{ background: 'linear-gradient(135deg, #0B8A8F 0%, #0ABBC2 100%)', boxShadow: '0 8px 32px rgba(11,138,143,0.30)' }}
          >
            <svg className="w-7 sm:w-8 h-7 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
        ...
        {/* Check circle */}
        <div className="check-pop flex items-center justify-center mb-5 sm:mb-6">
          <div
            className="w-16 sm:w-20 h-16 sm:h-20 rounded-full flex items-center justify-center"
            style={{
              background: 'linear-gradient(135deg, #0B8A8F 0%, #0ABBC2 100%)',
              boxShadow: '0 12px 40px rgba(11,138,143,0.35)',
            }}
          >
            <svg className="w-8 sm:w-10 h-8 sm:h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
        ...
        <div className="fade-up-1 mb-3">
          <span
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-3 sm:mb-4"
        ...
        {/* Subtext */}
        <div className="fade-up-2 mb-6 sm:mb-8">
          <p className="text-slate-600 text-sm sm:text-base md:text-lg leading-relaxed max-w-sm mx-auto">
        ...
        {/* Info cards */}
        <div className="fade-up-3 grid grid-cols-3 gap-2 sm:gap-3 mb-6 sm:mb-8">
          {[
            ...
            <div
              key={item?.label}
              className="bg-white rounded-2xl p-3 sm:p-4 text-center"
        ...
        <div className="fade-up-4 flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg touch-manipulation"
            style={{ background: 'linear-gradient(135deg, #0B8A8F, #0ABBC2)', boxShadow: '0 4px 20px rgba(11,138,143,0.30)', minHeight: 48 }}
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg touch-manipulation"
            style={{ background: 'linear-gradient(135deg, #25D366, #128C7E)', boxShadow: '0 4px 20px rgba(37,211,102,0.30)', minHeight: 48 }}
          >
        ...
        {/* Explore more */}
        <div className="fade-up-4 mt-6 sm:mt-8 pt-5 sm:pt-6" style={{ borderTop: '1px solid rgba(11,138,143,0.12)' }}>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {[
              ...
              <Link
                key={link?.href}
                href={link?.href}
                className="px-4 py-2 rounded-full text-xs font-semibold transition-all duration-200 hover:-translate-y-0.5 touch-manipulation"
                style={{
