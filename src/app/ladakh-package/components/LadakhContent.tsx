      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className={`text-center mb-14 reveal-up ${visible ? 'active' : ''}`}>
          <span
            ...
            style={{ background: 'rgba(11,138,143,0.10)', color: '#0B8A8F', border: '1px solid rgba(11,138,143,0.15)' }}>
        ...
        <div className={`reveal-up ${visible ? 'active' : ''} mb-16`}>
          <div
            className="bg-white rounded-3xl overflow-hidden border border-border/60"
            style={{ boxShadow: '0 8px 40px rgba(13,27,42,0.10)' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="relative h-72 lg:h-auto min-h-72 overflow-hidden">
                ...
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, rgba(11,138,143,0.3) 0%, transparent 60%)' }} />

                <div className="absolute top-4 left-4 flex flex-col gap-2">
                  <span
                    className="text-white text-xs font-bold px-3 py-1.5 rounded-full"
                    style={{ background: 'linear-gradient(135deg, #C8860E, #F0BC4A)', boxShadow: '0 2px 8px rgba(216,154,36,0.5)' }}>

                    Fixed Departure
                  </span>
                  <span
                    className="text-white text-xs font-bold px-3 py-1.5 rounded-full"
                    style={{ background: 'linear-gradient(135deg, #0B8A8F, #0ABBC2)', boxShadow: '0 2px 8px rgba(11,138,143,0.4)' }}>

                    8 Days / 7 Nights
                  </span>
                  <span
                    className="text-white text-xs font-bold px-3 py-1.5 rounded-full"
                    style={{ background: 'linear-gradient(135deg, #1a5276, #2980b9)', boxShadow: '0 2px 8px rgba(26,82,118,0.4)' }}>
              ...
              <div className="p-8 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-display text-2xl font-semibold text-foreground mb-4">
                    7 Nights Ladakh Group Trip Package
                  </h3>
                  ...
                  <div
                    ...
                    style={{ background: 'rgba(11,138,143,0.06)', border: '1px solid rgba(11,138,143,0.12)' }}>
                  ...
                  <div
                    className="rounded-2xl p-4 mb-5"
                    style={{ background: 'rgba(200,134,14,0.06)', border: '1px solid rgba(200,134,14,0.12)' }}>

                    <p className="text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: '#C8860E' }}>
                      🏨 Hotel Accommodation
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs">
                          Hotel Sindhu Residency / Hotel Holiday Ladakh / Welkin High / The Nangsay Hotel / Similar
                        </p>
                      </div>
                      <div>
                        <p className="font-semibold text-foreground">Nubra · 2 Nights</p>
                        <p className="text-muted-foreground text-xs">
                          The Latsas / Ldazes Camp / Hotel Thachung / Ladakh Heaven Hills / Paradise North / Similar
                        </p>
                      </div>
                      <div>
                        <p className="font-semibold text-foreground">Pangong · 1 Night</p>
                        <p className="text-muted-foreground text-xs">
                          Mystic Mountain Cottage / The Golden Cottage / LakeTso House Pangong / Similar
                        </p>
                      </div>
                      <div>
                        <p className="font-semibold text-foreground">Hanle · 1 Night</p>
                        <p className="text-muted-foreground text-xs">
                          Sonam Homestay / Dark Sky Homestay / Gua Homestay / Similar
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className={`reveal-up ${visible ? 'active' : ''} mb-16`}>
          ...
          <div key={month} className="mb-10">
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <span
                className="px-5 py-2 rounded-full text-white text-sm font-semibold tracking-wide"
                style={{ background: 'linear-gradient(135deg, #0B8A8F, #0ABBC2)', boxShadow: '0 4px 16px rgba(11,138,143,0.35)' }}>
        ...
        <div className={`reveal-up ${visible ? 'active' : ''} mb-16`}>
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{ background: 'linear-gradient(180deg, #0B8A8F, #0ABBC2, transparent)' }} />
            ...
            <div className="space-y-6">
              ...
              <div key={i} className="flex gap-6">
                  ...
                  <div
                  className="flex-1 bg-white rounded-2xl p-5 border border-border/60"
                  style={{ boxShadow: '0 2px 16px rgba(13,27,42,0.06)' }}>

                    <div className="flex items-center gap-3 mb-3">
                      <span
                      className="sm:hidden inline-flex items-center justify-center w-8 h-8 rounded-full text-white text-xs font-bold flex-shrink-0"
            ...
            <div className="bg-white rounded-3xl p-7 border border-border/60" style={{ boxShadow: '0 4px 24px rgba(13,27,42,0.06)' }}>
              ...
              <ul className="space-y-3">
                ...
                <li key={i} className="flex items-start gap-3 text-sm text-muted-foreground">
                    ...
                    style={{ background: 'rgba(11,138,143,0.10)' }}>
        ...
        <div className={`reveal-up ${visible ? 'active' : ''}`}>
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #0B8A8F 0%, #0ABBC2 100%)', boxShadow: '0 8px 40px rgba(11,138,143,0.35)' }}>
