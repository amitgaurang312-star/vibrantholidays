...
export default function FixedDeparturesHero() {
  return (
    <section className="relative w-full min-h-[52vh] flex items-end overflow-hidden bg-foreground">
      ...
      {/* Decorative orb */}
      <div className="absolute top-1/4 right-1/4 w-80 h-80 rounded-full opacity-15 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(10,187,194,0.5) 0%, transparent 70%)', filter: 'blur(60px)' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pb-14 pt-36 w-full">
        ...
        <h1 className="font-display text-hero-xl text-white font-semibold leading-tight mb-4 max-w-2xl">
          Fixed <span className="text-gradient-gold">Departures</span>
        </h1>
        <p className="text-white/75 text-lg max-w-xl leading-relaxed">
          Join our group departures — fixed dates, guaranteed departures, and the best travel companions.
        </p>
        {/* Breadcrumb */}
