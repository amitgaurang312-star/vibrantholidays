...
},
{
  ...
  video: "https://img.rocket.new/generatedImages/rocket_gen_img_1dcec2874-1780516401059.png",
  poster: "/assets/images/tourist-places-to-visit-in-north-east-india-1-1783921618853.jpg",
  duration: '6–9 Days',
  price: '₹20,000',
  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: dest.name === 'North East India' ? 220 : 280,
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-4 sm:p-6 z-10">
        ...
        <div>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-white text-primary px-4 sm:px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 hover:bg-accent hover:text-white sm:opacity-0 sm:group-hover:opacity-100 sm:translate-y-3 sm:group-hover:translate-y-0 touch-manipulation"
...
export default function DomesticDestinations() {
  ...
  return (
    <section id="destinations" ref={sectionRef} className="relative py-14 sm:py-20 lg:py-28 overflow-hidden" style={{ background: 'linear-gradient(180deg, #FFFFFF 0%, #F7F9FC 100%)' }}>
      {/* Subtle dot pattern */}
